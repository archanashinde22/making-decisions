...
{
  console.log(`Wear a t-shirt and take an umbrella toady.`);
...
{
  console.log(`Its Sunny Day , Wear short and tank Top`);
} 
else if (temperature > 60  && !rain)
{
  console.log(` Wear light Jacket today  !`);
}
else
{
  console.log(`Its chill weather out !`);
}
////////// PROBLEM 5 //////////
